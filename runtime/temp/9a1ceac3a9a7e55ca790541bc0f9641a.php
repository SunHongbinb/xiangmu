<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\erqi\public/../application/admin\view\login\index.html";i:1562656851;}*/ ?>
<!doctype html>
            ...
            layui.use('form', function(){
              ...
              form.on('submit(login)', function(data){
                ...
                $.ajax({
                  ...
                  ,error:function(data){
                    layer.msg(JSON.stringify("ajax连接错误"),function(){
