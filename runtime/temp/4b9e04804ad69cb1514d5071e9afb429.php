<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"D:\phpStudy\PHPTutorial\WWW\erqi\public/../application/admin\view\admin\index.html";i:1563413746;s:65:"D:\phpStudy\PHPTutorial\WWW\erqi\application\admin\view\base.html";i:1562921694;}*/ ?>
<!doctype html>
<html lang="en">
<head>
	<meta charset="utf-8">
...
<body>
    ...
    <div class="x-body">
      ...
      <xblock>
        <button class="layui-btn" onclick="x_admin_show('添加用户','<?php echo url('admin/admin/add'); ?>')"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        <?php foreach($admin as $v): ?>
          <tr>
            ...
            <td class="td-manage">
              <?php if($_SESSION['think']['admin_user']['state']==2): if($v['state']==0): ?>
              ...
              <?php endif; if($_SESSION['think']['admin_user']['id']==$v['id']): ?>
              <a title="编辑"  onclick="x_admin_show('编辑','<?php echo url('admin/admin/edit'); ?>?id=<?php echo $v['id']; ?>')" href="javascript:;">
                <i class="layui-icon">&#xe642;</i>
              </a>
              <?php endif; ?>
            </td>
      ...
      function member_stop(obj,id){
          ...
          layer.confirm(str,function(index){
              ...
              if($(obj).attr('title')=='启用'){
                $.ajax({
                    type:'get'
                    ,url: "<?php echo url('admin/admin/state'); ?>"
                    ,data:{id:id,state:1}
                    ,async:true
                    ,dataType:'text'
