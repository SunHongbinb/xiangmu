<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpStudy\PHPTutorial\WWW\erqi\public/../application/index\view\grzx\favorite.html";i:1563336317;s:65:"D:\phpStudy\PHPTutorial\WWW\erqi\application\index\view\Base.html";i:1563336630;}*/ ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="utf-8"/>
...
<section class="wrap user_center_wrap">
 <!--左侧导航-->
  ...
  <dl>
   <dt>买家中心</dt>
   <dd><a href="<?php echo url('index/order/index'); ?>">我的订单</a></dd>
   <dd><a href="#">我的收藏</a></dd>
  ...
  <dl>
   <dt>控制面板</dt>
   <dd><a href="#">站内短消息</a></dd>
   <dd><a href="#">资金管理</a></dd>
   <dd><a href="#">个人资料</a></dd>
   <dd><a href="<?php echo url('index/order/index'); ?>">修改密码</a></dd>
  </dl>
 </aside>
 <!--右侧：内容区域-->
 ...
 <?php foreach($array as $v): ?>
   <li>
    <a>
     ...
     <p class="price"><span class="rmb_icon"><?php echo $v['price']; ?></span></p>
