<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"D:\phpStudy\PHPTutorial\WWW\erqi\public/../application/admin\view\goods\index.html";i:1562675816;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
            ...
            <table class="layui-table same" id="main">
                ...
                <td>
                  <?php 
                   ...
                   $pl=count($arr);
                   $__FOR_START_25396__=0;$__FOR_END_25396__=$pl-1;for($i=$__FOR_START_25396__;$i < $__FOR_END_25396__;$i+=1){ ?>
                    ...
                    if($(obj).attr('title')=='上架'){
                      $.ajax({
                          ...
                          ,success:function(data){
                              ...
                              $(obj).parents("tr").find(".td-status").find('span').addClass('layui-btn-normal').html('在售中');
